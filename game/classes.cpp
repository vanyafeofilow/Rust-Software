...
namespace rust
{
	...
	RigidBody* PlayerWalkMovement::get_body()
	{
		...
		return memory::read<RigidBody*>(entity + 0xA0);//PlayerWalkMovement	body	0xa0	Rigidbody
	}
	...
	void Item::Fastbow()
	{
		...
		uintptr_t MaxDistance = offsets::hittest_maxDistance; //HitTest	MaxDistance	0x34	float
		if (!MaxDistance)
			return;
