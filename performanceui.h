...
namespace PerformanceUI
{
	...
	inline void ongui_hook(void* instance)
	{
		...
		//menu
		mid_framework::begin(xorstr_("MR DANGER"));
		...
		functions::outline(Vector4(10, 10, 150, 20), xorstr_("UK"), Vector4(0, 0, 0, 1));
		functions::label(Vector4(10, 10, 150, 20), xorstr_("UK"), Vector4(1, 1, 1, 1));
